...
void xyz_value_array_init(struct xyz_value_array *values)
{
    values->size = 0;
    values->capacity = 0;
    values->values = NULL;
...
void xyz_value_array_free(struct xyz_value_array *values)
{
    free(values->values);
    xyz_value_array_init(values);
}

void xyz_value_array_write(struct xyz_value_array *values, xyz_value value)
{
